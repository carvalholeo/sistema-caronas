...
describe("EmailService", () => {
  ...
  const setupDefaultMocks = () => {
    ...
    mockCompiledLayout.mockReturnValue(
      "<html><body>Mock Layout with Body</body></html>",
    );
  ...
  describe("Constructor and Initialization", () => {
    ...
    it("should handle initializeTemplates error and log it", async () => {
      ...
      // Assert
      expect(
        emailService.prepareEmailTemplate(
  ...
  describe("prepareEmailTemplate", () => {
    ...
    it("should prepare email template successfully", async () => {
      ...
      const fullHtml =
        "<html><body><h1>Hello John Doe</h1><p>Welcome!</p></body></html>";
    ...
    it("should throw error when template is not initialized", async () => {
      ...
      await expect(
        ...
        'Template de e-mail "non-existent-template" não foi inicializado.',
      );
    });
    ...
    it("should return processed HTML with inline CSS", async () => {
      ...
      const expectedProcessedHtml =
        "<html><head><style>body{color:red}</style></head><body><h1>Test</h1></body></html>";
  ...
  describe("Edge Cases and Error Handling", () => {
    ...
    it("should handle Map operations correctly", async () => {
      ...
      (emailServiceInstance as any).templates.get?.(
        MockEmailTemplate.PasswordResetRequest,
      );
    ...
    it("should handle concurrent template preparations", async () => {
      ...
      const promises = [
        emailServiceInstance.prepareEmailTemplate(
          MockEmailTemplate.PasswordResetRequest as any,
          templateData1 as any,
        ),
        emailServiceInstance.prepareEmailTemplate(
          MockEmailTemplate.PasswordResetSuccess as any,
          templateData2 as any,
        ),
      ];
