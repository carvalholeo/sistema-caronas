...
import {
  ...
  manageSeatValidator,
} from "../middlewares/validators/rides";
...
rideRouter.post(
  ...
  recurrentRideValidator,
  requestValidator,
  rideController.createRecurrent,
);
...
rideRouter.get(
  "/passenger",
  requestValidator,
  rideController.getMyRidesAsPassenger,
);
